#!/usr/bin/env python3
"""Descarga velas OHLCV BCHUSDT M15 desde Binance Spot API pública."""
import requests
import pandas as pd
import time
from datetime import datetime, timezone

OUT = "/workspaces/TradingAIProject/data/bch_usdt_m15.csv"
SYMBOL = "BCHUSDT"
INTERVAL = "15m"
LIMIT = 1000
...
print(f"Descargando {SYMBOL} M15 desde {start_dt.date()} hasta {end_dt.date()} ...")
