#!/usr/bin/env python3
"""Descarga velas OHLCV BCHUSDT H1 desde Binance Spot API pública."""
import requests
import pandas as pd
import time
from datetime import datetime, timezone

OUT = "/workspaces/TradingAIProject/data/bch_usdt_h1.csv"
SYMBOL = "BCHUSDT"
INTERVAL = "1h"
LIMIT = 1000
BASE = "https://api.binance.com/api/v3/klines"

start_dt = datetime(2021, 10, 1, tzinfo=timezone.utc)
end_dt = datetime(2026, 7, 24, tzinfo=timezone.utc)

start_ms = int(start_dt.timestamp() * 1000)
end_ms = int(end_dt.timestamp() * 1000)

print(f"Descargando {SYMBOL} H1 desde {start_dt.date()} hasta {end_dt.date()} ...")
